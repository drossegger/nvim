...
-- provide compiling icon
function provide_texwc(component,opts)
  return 'wc: ' .. vim.call('vimtex#misc#wordcount')
end
--
...
local cond_components={
  condition=function()
    --return vim.api.nvim_buf_get_option(0,'filetype')=='tex'
    return true
  end,
  active={
    {
      name = 'vimtex',
      provider = wrapped_provider(provide_texwc, wrap_right),
      left_sep = 'slant_left',
      hl = {
        bg = 'white',
        fg = 'black',
